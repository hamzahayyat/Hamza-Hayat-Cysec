  ...
  return (
    <Router>
      <div className="app-container" style={{ position: 'relative' }}>
        ...
        <footer style={{ textAlign: 'center', padding: '2rem 0', borderTop: '1px solid rgba(255,255,255,0.05)', marginTop: 'auto', color: 'var(--text-dark)', fontSize: '0.9rem', position: 'relative', zIndex: 10 }}>
